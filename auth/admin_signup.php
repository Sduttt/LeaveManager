...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $isExistsResult = mysqli_query($conn, $isExists);
    
    if (mysqli_num_rows($isExistsResult) > 0) $exists = true;
            ...
            <form action="" method="post" class="mt-8">
                <div class="space-y-5">
                    <div>
                        ...
                        <div class="mt-2">
                            <input
                                class="flex h-10 w-full rounded-md border border-gray-300 bg-transparent px-3 py-2 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"required

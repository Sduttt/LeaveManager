    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="apply_leave.php"
                    ...
                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        <path
                            d="M10 1.25C9.58579 1.25 9.25 1.58579 9.25 2.00001V9.25H2.00001C1.58579 9.25 1.25 9.58579 1.25 10C1.25 10.4142 1.58579 10.75 2.00001 10.75H9.25V17.9999C9.25 18.4141 9.58579 18.7499 10 18.7499C10.4142 18.7499 10.75 18.4141 10.75 17.9999V10.75H18C18.4142 10.75 18.75 10.4142 18.75 10C18.75 9.58579 18.4142 9.25 18 9.25H10.75V2.00001C10.75 1.58579 10.4142 1.25 10 1.25Z" />
                    </svg>
            ...
            <li>
                <a href="leave_account.php"
                    ...
                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        <path
                            d="M16.6667 1.66667H3.33333C2.6 1.66667 2 2.26667 2 3V16.3333C2 17.0667 2.6 17.6667 3.33333 17.6667H16.6667C17.4 17.6667 18 17.0667 18 16.3333V3C18 2.26667 17.4 1.66667 16.6667 1.66667ZM3.33333 3.33333H16.6667V6.66667H3.33333V3.33333ZM3.33333 8.33333H16.6667V11.6667H3.33333V8.33333ZM3.33333 12.3333H16.6667V15.6667H3.33333V12.3333Z" />
                    </svg>
            ...
            <li class="border-t fixed bottom-4 w-[calc(100%-16rem)] pt-4 px-2 flex items-end">
                <h1 class="font-bold text-2xl text-gray-700 my-3">Developed by:</h1>
